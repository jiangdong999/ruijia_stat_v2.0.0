...
layui.define(function(e) {
    ...
    u.prototype.view = function() {
        ...
        i = {
            ...
            count: '<span class="layui-laypage-count" style="float:left">共 ' + a.count + " 条记录 </span>",
            limit: function() {
            ...
            skip: function() {
                return ['<span class="layui-laypage-skip">跳至', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '&#x9875;<button type="button" class="layui-laypage-btn">GO</button>', "</span>"].join("")
            } ()
        };
        return ['<div class="layui-box layui-laypage layui-laypage-' + (a.theme ? /^#/.test(a.theme) ? "molv": a.theme: "default") + '" id="layui-laypage-' + a.index + '" style="text-align:right">',
        function() {
            var e = [];
